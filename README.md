...
jobs:
  security:
    ...
    steps:
      ...
      - uses: cisoventures/RepoRook@117f9b8025073eedbcb08db5223ff2c2f72cfe79 # v1.0.0 source pin
        with:
          fail-on: high
          mode: diff
